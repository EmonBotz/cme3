...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('BotMee MD', {
		font: 'Standard',
...
const connectToWhatsApp = async () => {
	const conn = makeWASocket({
            ...
            auth: state,
            browser: ["Emon Bot Multi Device", "Safari", "3.0"]
        })
	title()
        store.bind(conn.ev)
